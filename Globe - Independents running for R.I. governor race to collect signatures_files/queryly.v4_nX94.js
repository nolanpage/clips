...
(function (window) {
    queryly = {
        ...
        init: function (querylykey, maincontent, config) {
            if (!querylykey || !querylykey.trim()) {
                console.warn('Missing or invalid Queryly Key. Please contact support@queryly.com.');
                return;
            }
            try {
